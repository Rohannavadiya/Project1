            ...
            <tr>
                <td>
                    <select name="batchid" id="batchid" class="input-box">
                        ...
                        <?php
                         //var_dump($_POST);
                            $sql = "select id,classtime from batch order by id";
                            $cmd = $db -> prepare($sql);
                            $cmd->execute();
                            $table = $cmd -> fetchAll();
        ...
        <table align="center" class="data">
            ...
            <tbody>
                ...
                if (isset($_POST['submit']) == true) {
                    ...
                    $sql = "select lecturedate,amount,duration,payoutid,t.fullname,s.title from lecture l,subject s, teacher t where batchid=? and (lecturedate>=? and lecturedate<=?) and l.subjectid=s.id and l.teacherid=t.id";
                    var_dump($_POST);
                    $cmd = $db->prepare($sql);
